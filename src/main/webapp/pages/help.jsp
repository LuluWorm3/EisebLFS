...
<style>body{display:flex;}.main{flex:1;} .card-content {padding:24px;} h3 {font-family:'Playfair Display',serif; font-size:20px; margin-bottom:8px; color:var(--earth);} p,li{color:var(--muted);font-size:14px;line-height:1.7;} ul{padding-left:24px;margin:8px 0 16px;}</style>
</head><body>
  ...
  <div class="content">
    <div class="full-card">
      ...
      <div class="card-content">
        <p>Welcome to the Eiseb Livestock Financial System. Here is how to use each section:</p>
        <h3>Dashboard</h3>
        ...
        <p>View, add, edit, and delete animals. Search, sort, and bulk‑delete. Filter by Active, Sold, or Deceased.</p>
        <h3>Valuations</h3>
        <p>Record valuations for animals to track their current value over time.</p>
        <h3>Sales & Income</h3>
        <p>Manage all sales. Add a new sale with buyer details, sale type, and payment status. Paid sales mark the animal as Sold.</p>
        <h3>Expenses</h3>
        <p>Log expenses by category (Feed, Vet, Transport, etc.). You can optionally link an expense to a specific animal.</p>
        <h3>Financial Reports</h3>
        <p>View detailed summaries, filter by date range, and export CSV files.</p>
        <h3>My Profile</h3>
        <p>Update your full name, email, and password.</p>
